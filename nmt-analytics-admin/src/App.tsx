    ...
    <Router>
      <Routes>
        ...
        <Route element={<AuthGuard><AppLayout /></AuthGuard>}>
          ...
          <Route path="/operations/flights" element={<SuspenseWrapper><ModuleGuard moduleKey="travel_core" fallback={<NotFoundClientOnly />}><FlightsPage /></ModuleGuard></SuspenseWrapper>} />
