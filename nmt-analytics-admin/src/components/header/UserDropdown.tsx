...
export default function UserDropdown() {
  ...
  const { user, userContext, profileLoading } = useApp();
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex items-center justify-center mr-3 overflow-hidden bg-gray-100 rounded-full h-11 w-11 dark:bg-gray-800">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      >
        <div>
          ...
          <span className="mt-0.5 block text-theme-xs text-gray-400 dark:text-gray-500">
            Organization: {profileLoading ? 'Loading...' : (userContext?.org?.name || 'pending')}
          </span>
        </div>
