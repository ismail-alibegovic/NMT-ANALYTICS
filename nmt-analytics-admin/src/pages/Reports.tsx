...
export default function Reports() {
    ...
    return (
        <>
            <PageMeta
                title="Izvještaji | NMT Analytics"
                description="Finansijski izvještaji i analitika"
            />

            <PageToolbar
                title="Izvještaji"
                description="Finansijski pregled i analitika po paketima"
                searchValue=""
                onSearchChange={() => { }}
                searchPlaceholder=""
            />
            ...
            <div className="mb-6 flex flex-wrap gap-4 items-center">
                ...
                <button
                    ...
                    className="ml-auto px-4 py-2 text-sm font-medium text-white bg-brand-500 hover:bg-brand-600 rounded-lg transition-colors flex items-center gap-2"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="w-12 h-12 rounded-full bg-success-50 dark:bg-success-950/20 flex items-center justify-center">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-warning-600 dark:text-warning-400">
                                    {overview.partially_paid_count}
                                </p>
                            </div>
                            <div className="w-12 h-12 rounded-full bg-warning-50 dark:bg-warning-950/20 flex items-center justify-center">
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="w-12 h-12 rounded-full bg-error-50 dark:bg-error-950/20 flex items-center justify-center">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 mb-8">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                        Prihod tokom vremena
                    </h2>
                    <div className="flex gap-2">
                        <button
                            onClick={() => setBucket('daily')}
                            className={`px-3 py-1 text-sm rounded-lg transition-colors ${bucket === 'daily'
                        ...
                        <button
                            ...
                            className={`px-3 py-1 text-sm rounded-lg transition-colors ${bucket === 'weekly'
                                ? 'bg-brand-500 text-white'
                                : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700'
                                }`}
                        >
