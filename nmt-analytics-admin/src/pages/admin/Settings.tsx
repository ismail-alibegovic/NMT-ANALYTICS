          ...
          {showSmtpForm && (
            <div className="space-y-4">
              ...
              <div className="flex gap-3 items-end">
                ...
                {/* Invoice Settings */}
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Faktura (PDF) postavke</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Ove informacije će se prikazivati na generisanim PDF fakturama i voucherima.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Porezni broj (ID)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bankovni račun</label>
              <input
                type="text"
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Završni tekst na fakturi</label>
              <textarea
                value={settings.invoice_footer}
                onChange={(e) => setSettings({ ...settings, invoice_footer: e.target.value })}
                rows={3}
                placeholder="Hvala Vam na povjerenju. Za sva pitanja stojimo na raspolaganju."
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent"
              />
            </div>
          </div>
