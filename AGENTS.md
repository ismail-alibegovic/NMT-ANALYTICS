...
1. **UX redesign — REVERTED 2026-08-01 (`4c78367`).** Passes A/B/C (PageShell frame, DataTable sort + row-click, HomeHub range control + Needs Attention worklist) were implemented across commits `4d63aac`, `8f625fe`, `818d76c`, `e7a0bd3` and then **fully reverted** — Ismail's verdict: "samo si pokvario izgled, sada je sve poremeceno i razbijeno, nije poredano lijepo, brojevi i dosta stvari vise nije kako treba". The admin UI is now byte-identical to `36f465f`; only Sentry (`b573e98`) sits on top.
