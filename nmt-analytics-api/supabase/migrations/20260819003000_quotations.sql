CREATE TABLE IF NOT EXISTS quotations (
  ...
  global_markup_percent NUMERIC(5,2) DEFAULT 0 CHECK (global_markup_percent >= 0 AND global_markup_percent <= 1000),
  sell_total NUMERIC(14,2) NOT NULL DEFAULT 0 CHECK (sell_total >= 0),
...
CREATE INDEX IF NOT EXISTS idx_quotations_org_reference ON quotations(org_id, reference);
...
COMMENT ON TABLE quotations IS 'Fixed-price offers generated from locked itinerary versions with supplier-cost and customer-price snapshots.';
