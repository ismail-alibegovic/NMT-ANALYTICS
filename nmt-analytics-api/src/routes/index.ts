...
import communicationSendRoutes from './communicationSend';
...
import packageCostingRoutes from './packageCosting';
import packageHotelsRoutes from './packageHotels';
...
router.use('/', packageCostingRoutes);
router.use('/', packagesRoutes);
router.use('/', departureProfitabilityRoutes);
...
router.use('/', communicationSendRoutes);
...
router.use('/', packageHotelsRoutes);
