...
export async function generateContractPDF(contract: any, branding?: BrandingWithConfig): Promise<Buffer> {
  return renderTemplatedPDF('contract', contract, branding?.pdfTemplateConfig, brandingOverrides(branding));
}
