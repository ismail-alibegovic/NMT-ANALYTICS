...
docs/tasks/
├── README.md
├── INDEX.md            ← Master breakdown: 42 sections → 38 atomic tasks
├── TEMPLATE.md
├── 01-core-crud.md     ← Phase 1: T01–T03
├── 02-package-transport.md
├── ...
├── 15-e2e-production.md ← Phase 15: T37–T38
├── active/
...
> **Master requirements breakdown**: `INDEX.md` maps all 42 sections of the master requirements into 38 atomic tasks across 15 phases. Each phase file (`01-*.md` through `15-*.md`) contains the corresponding task definitions. Find the right task in `INDEX.md`, then create an active spec using `TEMPLATE.md`.
